...
public class colorReplace {
	...
	public static void ExtractRed(String imgpath,String Id) throws IOException {
		int countnum = 0;
		...
		ImageIO.write(bufferedImage1, "jpg", new File(System.getProperty("user.dir") + "/picture/"+Id+"24.jpg"));
	}

...
//		
				...
				String imgformatpath="D:\\验证码训练数据\\liaoning\\suanshu\\2.format";
				FileWriter writer  =new  FileWriter(imgformatpath);
				String imgformatpath1="D:\\验证码训练数据\\liaoning\\suanshu\\2test.format";
				FileWriter writer1  =new  FileWriter(imgformatpath1);
				for(int j=0;j<filename.size();j++){
					for(int i=1;i<201;i++){
						String imgpath="D:\\验证码训练数据\\liaoning\\suanshu\\2\\"+filename.get(j)+"\\"+i+".jpg";
						System.out.println(imgpath);
						String imgOutputpath="D:\\验证码训练数据\\liaoning\\suanshu\\2\\"+filename.get(j)+"\\"+i+".jpg";

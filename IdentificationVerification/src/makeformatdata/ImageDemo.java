...
public class ImageDemo {
    ...
    public static void BinaryValue(FileWriter writer,FileWriter writer1,String s1,String s2,String t) throws IOException {
    	//将图像rgb值二值化
    	//File newFile = new File(System.getProperty("user.dir")+"/dataset/"+s1+".format");
    	File newFile = new File(s1);
    	//FileWriter writer  =new  FileWriter(newFile);
    	//File file = new File(System.getProperty("user.dir")+"/picture/"+s2+".jpg");
...
//     	writer.close();
    ...
    public static void BinaryValue(String s1,String s2) throws IOException {
    	//将图像rgb值二值化
    	//File newFile = new File(System.getProperty("user.dir")+"\\dataset\\"+s1+".format");
    	File newFile = new File("D:\\DownLoad\\dataset\\" + s1 + ".format");
    	//File newFile = new File(s1);
    	FileWriter writer  =new  FileWriter(newFile);
    	//File file = new File(System.getProperty("user.dir")+"\\picture\\"+s2+".jpg");
    	File file = new File("D:\\DownLoad\\" + s2 + ".jpg");
